...
public class TweenTest : MonoBehaviour
{
    ...
    void Start()
    {
        //tween = transfrom.DOMoveX(5, 2);                   //Tween을 통해서 오브젝트는 X축으로 2초동안 5만큼 간다.
        ...
        //transform.DOMoveX(5, 2f).SetEase(Ease.OutBounce).OnComplete(DeactivateObject);         //이동할 때 효과를 추가시킬 수 있다. (Ease.OutBounce)
        ...
        sequence.SetLoops(-1, LoopType.Yoyo);          //루프를 돌리기 위한 옵션들 설정
